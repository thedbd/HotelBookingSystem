...
$(document).ready(function() {
    ...
    $('#pass').on('blur keyup', function(e) {
        var pass = $('#pass').val();
        if (pass.length == "") {
            $('#show').html('password must be filled');
            $('#show').css('color', 'red');
            return false;
        } else {
            if (pass.length < 8) {
                $('#show').html('password must have 8 character');
                $('#show').css('color', 'red');
                return false;
            } else {
                $('#show').html('');
    ...
    $('#cpass').keyup(function() {
        ...
        if (pass != cpass) {
            ...
            $('#showError').html('password are matched');
 	...
 	jQuery.ajax({
      ...
      success: function(response){
         ...
         // $('#email').parent().addClass("form_error");
          $('#email').siblings("p").text('Sorry... Email already taken');
           $('#email').siblings("p").css('color','red');
      	}else if (response == 'not_taken') {
      	  email_state = true;
      	 // $('#email').parent().removeClass();
      	 // $('#email').parent().addClass("form_success");
      	  $('#email').siblings("p").text('Email available');
              $('#email').siblings("p").css('color','green');
      	}
      }
 	});
 });
            ...
            <form id="regform" action="" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label>Email</label><span style="color: red !important; display: inline; float: none;">*</span><br>
                        <input type="email" class="form-control" style="width:50% !important; display: inline !important;" required name="email" id="email" placeholder="">
                         <p class="ml-2" style="color: red !important; display: inline; float: none;"> </p>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label>Confirm Password</label><span
                            style="color: red !important; display: inline; float: none;">*</span>
                        <input type="password" class="form-control" name="cpass" id="cpass" placeholder="" required>
                ...
                <div class=" row ">
                    <div class=" col-md-12 col-sm-12 ">
                        <div class=" form-row ">
                            <input type="submit" class="btn btn-prime btn-lg" value="Sign up" />


                        </div>
                        <div class=" form-row ">
                            Already have an account? <a href="?p=login"> Login Here</a>
                        </div>
                    </div>
                </div>
            </form>
